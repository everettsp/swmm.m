...
case {'map','draw','symbolspec','symspec'}
    ...
    case {'attributes'}
        ...
        dict.infiltration.green_ampt = ["Subcatchment", "Suction", "Ksat", "IMD","PlaceHolder1","PlaceHolder2"];
        dict.infiltration.modified_green_ampt = ["Subcatchment", "Suction", "Ksat", "IMD","PlaceHolder1","PlaceHolder2"];
        dict.infiltration.curve_number = ["Subcatchment", "CurveNum", "Conductivity", "DryTime", "Param4", "Param5"];
...
%         dict.raingages.file = ["Name", "Format", "Interval", "SCF", "Source","SourceName",];
    ...
    case {'results','res'}
        ...
        dict.NodeFloodingSummary = ["Node","HoursFlooded","MaxRate","DayOfMaxOccurence","TimeOfMaxOccurence","TotalFloodVolume","MaximumPondedVolume"];
        ...
        dict.ConduitSurchargeSummary = ["Conduit","HoursFullBothEnds","HoursFullUpstream","HoursFullDownstream","HoursAboveFullNormalFlow","HoursCapacityLimited"];
